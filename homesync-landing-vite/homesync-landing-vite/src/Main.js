...
const TRANSLATIONS = {
  fr: {
    ...
    benefit3: "Le dîner est décidé avant même d'y penser.",
    benefit4: "Plus de listes de courses perdues.",
    benefit5: "Plus de tâches oubliées.",
    cta_nav: "Essayer gratuitement",
    ...
    intro_trust: "7 jours gratuits · Sans engagement · Jusqu'à 6 membres · Android, iPhone et Web",
    ...
    amb_clear_history_btn: "Effacer",
    amb_clear_history_confirm: "Confirmer ?",
    ...
    mc_stock_tag: "📦 Stock", mc_stock_q: "Vous savez toujours ce qu'il vous reste.", mc_stock_a: ["Chaque produit affiche sa date de péremption, pour ne jamais être pris de court.", "Cuisinez une recette et le stock se met à jour tout seul.", "Presque vide ? L'article part directement dans vos courses.", "Je ne fais plus l'inventaire du frigo dans ma tête — un coup d'œil et je sais s'il reste des œufs."],
    mc_courses_tag: "🛒 Courses", mc_courses_q: "La liste se remplit sans vous.", mc_courses_a: ["Ajoutez un article en tapant, ou collez toute une liste d'un coup.", "Cochez au fur et à mesure — une fois validée, la liste rejoint automatiquement le stock.", "Vos listes types se sauvegardent pour la semaine suivante.", "Je ne me demande plus ce qu'on a oublié — la liste est déjà là, mise à jour par toute la famille."],
    mc_budget_tag: "💰 Budget", mc_budget_q: "Plus de mauvaise surprise en fin de mois.", mc_budget_a: ["Le total se calcule pendant vos courses, avant même la caisse.", "Connecté directement aux courses et aux charges récurrentes comme le loyer.", "Un résumé s'exporte en PDF à tout moment.", "Je ne découvre plus le montant à la fin du mois — je vois où part chaque euro, en temps réel."],
    mc_recettes_tag: "🍳 Recettes", mc_recettes_q: "Le dîner est déjà décidé.", mc_recettes_a: ["Cuisinez un plat, et les ingrédients sont déduits automatiquement de votre stock.", "Il vous manque quelque chose ? Un bouton l'ajoute directement aux courses.", "Planifiez la semaine, la liste se génère toute seule.", "Je ne fais pas que juste enregistrer mes recettes — je planifie les repas de chaque personne, ça m'évite de réfléchir à quoi manger."],
    mc_agenda_tag: "📅 Agenda", mc_agenda_q: "Chacun sait ce qu'il a à faire.", mc_agenda_a: ["Les dates de péremption du stock y apparaissent automatiquement, tout comme vos charges récurrentes.", "Toute la famille voit les mêmes rendez-vous, en temps réel.", "Un rappel arrive automatiquement avant l'échéance.", "Je n'ai plus à rappeler à tout le monde qui doit faire quoi — chacun voit son planning, sans que j'aie à répéter."],
    mc_membres_tag: "👥 Membres", mc_membres_q: "Plus besoin de tout répéter à chacun.", mc_membres_a: ["Chaque membre se connecte depuis son propre appareil.", "Ce que l'un ajoute, les autres le voient à l'instant.", "Invitez en un clic, avec un simple code ou un QR code.", "Un seul abonnement suffit pour jusqu'à 6 membres — personne ne paie de son côté.", "Je n'ai plus à envoyer 10 messages pour prévenir tout le monde — ils voient directement."],
  ...
  en: {
    ...
    benefit3: "Dinner is decided before you even think about it.",
    ...
    intro_trust: "7 days free · No commitment · Up to 6 members · Android, iPhone and Web",
    ...
    amb_clear_history_btn: "Clear",
    amb_clear_history_confirm: "Confirm?",
...
(function initAmbassadorSpace() {
  ...
  async function loadDashboard() {
    ...
    // seule fois avec une bannière, plutôt que de laisser passer inaper
