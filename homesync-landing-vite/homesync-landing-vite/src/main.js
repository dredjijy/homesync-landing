...
const TRANSLATIONS = {
  fr: {
    ...
    mc_membres_tag: "👥 Membres", mc_membres_q: "Tout le monde voit la même chose, au même moment.", mc_membres_a: ["Chaque membre se connecte depuis son propre appareil.", "Ce que l'un ajoute, les autres le voient à l'instant.", "Invitez en un clic, avec un simple code ou un QR code.", "Un seul abonnement suffit pour jusqu'à 6 membres — personne ne paie de son côté.", "Je n'ai plus à envoyer 10 messages pour dire la même chose — tout le monde voit la même info, au même moment."],
